...
function BestSeller() {
  ...
  return (
    <>
      <div className="bg-white shadow-sm flex flex-row items-center w-full gap-2 h-14">
        <span className="ml-5">
      ...
      <h2 className="text-2xl ml-14 mt-5 font-bold">Best Sellers</h2>
      <div className="w-full mt-0 max-w-7xl mx-auto px-4  pb-5 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-4">
