      ...
      {/*<div className="m-0 w-full min-h-screen bg-gray-50" id="wrapper">*/}
        ...
        >
          ...
          >
            <img
              ...
              alt="..."
            />
            <h5 className="text-sm ml-[1%]">Black Standing Fan</h5>
            <p className="leading-[5px] text-sm ml-[1%]">
              <b> &#8358;10,000</b>
            </p>
            <p className="no-underline leading-[5px] text-sm ml-[1%]">
          ...
          >
            ...
            <p
              style={{ lineHeight: "5px", fontSize: "15px", marginLeft: "1%" }}
            >
              <b> &#8358; 15,000</b>
            </p>
            <p
        ...
        >
          ...
          >
            ...
            <img
              src="/mockup-image/appliannces-mockup.png "
              className="h-[424px] "
              alt="appliances mockup"
            />
          </div>
        ...
        >
          ...
          >
            ...
            <img
              className="h-[424px]"
              src="/mockup-image/gadgets-mockup.png"
              alt="gadget-mockup"
            />
          </div>
          ...
          >
            <img
              ...
              alt="..."
            />
            <h5 className="text-sm mb-0 ml-[5%] mt-0 ">Xiaomi Redmi Pad SE</h5>
          ...
          >
            <img
              ...
              alt="..."
            />
            <h5 className="text-sm mb-[0.5px] m-=[5%] mt-0 ">
              4G Tecno tablet
            </h5>
            <p className="mb-0 text-sm ml-[5%]">
              <b> &#8358; 120,000</b>
        ...
        >
          ...
          >
            ...
            <img
              src="/mockup-image/beauty-mockup.png"
              className="h-[424px]"
              alt=".."
            />
          </div>
        ...
        >
          ...
          >
            ...
            <img
              className=" h-[424px]"
              src="/mockup-image/fashion-mockup.png"
              alt="fashion mockup"
            />
          </div>
